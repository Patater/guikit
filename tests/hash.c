...
/* TESTV macro does not include trailing NUL byte in the test vector */
#define TESTV(x) {x, LEN(x)}
/* TESTV0 macro includes the trailing NUL byte in the test vector */
#define TESTV0(x) {x, sizeof(x)}
...
struct test_vector fnv_test_str[] = {
  ...
  TESTV("chongo was h"),
  TESTV("chongo was he"),
  TESTV("chongo was her"),
  TESTV("chongo was here"),
  TESTV("chongo was here!"),
  TESTV("chongo was here!\n"),
  ...
  TESTV0("chongo was "),
  TESTV0("chongo was h"),
  TESTV0("chongo was he"),
  TESTV0("chongo was her"),
  TESTV0("chongo was here"),
  TESTV0("chongo was here!"),
  TESTV0("chongo was here!\n"),
  ...
  TESTV0("curds and w"),
  TESTV0("curds and wh"),
  TESTV0("curds and whe"),
  TESTV0("curds and whey"),
  TESTV0("curds and whey\n"),
  ...
  TESTV("\xff\x00\x00\x01"),
  TESTV("\x01\x00\x00\xff"),
  TESTV("\xff\x00\x00\x02"),
  TESTV("\x02\x00\x00\xff"),
  TESTV("\xff\x00\x00\x03"),
  TESTV("\x03\x00\x00\xff"),
  TESTV("\xff\x00\x00\x04"),
  TESTV("\x04\x00\x00\xff"),
  TESTV("\x40\x51\x4e\x44"),
  TESTV("\x44\x4e\x51\x40"),
  TESTV("\x40\x51\x4e\x4a"),
  TESTV("\x4a\x4e\x51\x40"),
  TESTV("\x40\x51\x4e\x54"),
  TESTV("\x54\x4e\x51\x40"),
  ...
  TESTV("feedface"),
  TESTV0("feedface"),
  TESTV("feedfacedaffdeed"),
  TESTV0("feedfacedaffdeed"),
  TESTV("feedfacedeadbeef"),
  TESTV0("feedfacedeadbeef"),

  TESTV("line 1\nline 2\nline 3"),

  TESTV("chongo <Landon Curt Noll> /\\../\\"),
  TESTV0("chongo <Landon Curt Noll> /\\../\\"),

  TESTV("chongo (Landon Curt Noll) /\\../\\"),
  TESTV0("chongo (Landon Curt Noll) /\\../\\"),

  TESTV("http://antwrp.gsfc.nasa.gov/apod/astropix.html"),
  TESTV("http://en.wikipedia.org/wiki/Fowler_Noll_Vo_hash"),
  TESTV("http://epod.usra.edu/"),
  TESTV("http://exoplanet.eu/"),
  TESTV("http://hvo.wr.usgs.gov/cam3/"),
  TESTV("http://hvo.wr.usgs.gov/cams/HMcam/"),
  TESTV("http://hvo.wr.usgs.gov/kilauea/update/deformation.html"),
  TESTV("http://hvo.wr.usgs.gov/kilauea/update/images.html"),
  TESTV("http://hvo.wr.usgs.gov/kilauea/update/maps.html"),
  TESTV("http://hvo.wr.usgs.gov/volcanowatch/current_issue.html"),
  TESTV("http://neo.jpl.nasa.gov/risk/"),
  TESTV("http://norvig.com/21-days.html"),
  TESTV("http://primes.utm.edu/curios/home.php"),
  TESTV("http://slashdot.org/"),
  TESTV("http://tux.wr.usgs.gov/Maps/155.25-19.5.html"),
  TESTV("http://volcano.wr.usgs.gov/kilaueastatus.php"),
  TESTV("http://www.avo.alaska.edu/activity/Redoubt.php"),
  TESTV("http://www.dilbert.com/fast/"),
  TESTV("http://www.fourmilab.ch/gravitation/orbits/"),
  TESTV("http://www.fpoa.net/"),
  TESTV("http://www.ioccc.org/index.html"),
  TESTV("http://www.isthe.com/cgi-bin/number.cgi"),
  TESTV("http://www.isthe.com/chongo/bio.html"),
  TESTV("http://www.isthe.com/chongo/index.html"),
  TESTV("http://www.isthe.com/chongo/src/calc/lucas-calc"),
  TESTV("http://www.isthe.com/chongo/tech/astro/venus2004.html"),
  TESTV("http://www.isthe.com/chongo/tech/astro/vita.html"),
  TESTV("http://www.isthe.com/chongo/tech/comp/c/expert.html"),
  TESTV("http://www.isthe.com/chongo/tech/comp/calc/index.html"),
  TESTV("http://www.isthe.com/chongo/tech/comp/fnv/index.html"),
  TESTV("http://www.isthe.com/chongo/tech/math/number/howhigh.html"),
  TESTV("http://www.isthe.com/chongo/tech/math/number/number.html"),
  TESTV("http://www.isthe.com/chongo/tech/math/prime/mersenne.html"),
  TESTV("http://www.isthe.com/chongo/tech/math/prime/mersenne.html#largest"),
  TESTV("http://www.lavarnd.org/cgi-bin/corpspeak.cgi"),
  TESTV("http://www.lavarnd.org/cgi-bin/haiku.cgi"),
  TESTV("http://www.lavarnd.org/cgi-bin/rand-none.cgi"),
  TESTV("http://www.lavarnd.org/cgi-bin/randdist.cgi"),
  TESTV("http://www.lavarnd.org/index.html"),
  TESTV("http://www.lavarnd.org/what/nist-test.html"),
  TESTV("http://www.macosxhints.com/"),
  TESTV("http://www.mellis.com/"),
  TESTV("http://www.nature.nps.gov/air/webcams/parks/havoso2alert/havoalert.cfm"),
  TESTV("http://www.nature.nps.gov/air/webcams/parks/havoso2alert/timelines_24.cfm"),
  TESTV("http://www.paulnoll.com/"),
  TESTV("http://www.pepysdiary.com/"),
  TESTV("http://www.sciencenews.org/index/home/activity/view"),
  TESTV("http://www.skyandtelescope.com/"),
  TESTV("http://www.sput.nl/~rob/sirius.html"),
  TESTV("http://www.systemexperts.com/"),
  TESTV("http://www.tq-international.com/phpBB3/index.php"),
  TESTV("http://www.travelquesttours.com/index.htm"),
  TESTV("http://www.wunderground.com/global/stations/89606.html"),
  ...
  TESTV(R10("\x5a\xa9")),
  TESTV(R10("\xa9\x5a")),
  TESTV(R10("391581216093")),
  TESTV(R10("391581*2^216093-1")),
  TESTV(R10("\x05\xf9\x9d\x03\x4c\x81")),
  TESTV(R10("FEDCBA9876543210")),
  TESTV(R10("\xfe\xdc\xba\x98\x76\x54\x32\x10")),
  TESTV(R10("EFCDAB8967452301")),
  TESTV(R10("\xef\xcd\xab\x89\x67\x45\x23\x01")),
  TESTV(R10("0123456789ABCDEF")),
  TESTV(R10("\x01\x23\x45\x67\x89\xab\xcd\xef")),
  TESTV(R10("1032547698BADCFE")),
  TESTV(R10("\x10\x32\x54\x76\x98\xba\xdc\xfe")),
  TESTV(R500("\x00")),
  TESTV(R500("\x07")),
  TESTV(R500("~")),
  TESTV(R500("\x7f")),
